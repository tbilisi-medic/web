        ...
        <div className="mx-auto max-w-7xl py-20">
          ...
          <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/20 pt-8 sm:flex-row">
            ...
            <div className="flex items-center gap-1">
              <a
                href="https://www.facebook.com/Tbilisimedic/"
                target="_blank"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 hover:bg-white/8 transition-colors"
                aria-label="Facebook"
              >
                <svg
                  className="h-5 w-5"
              ...
              <a
                href="https://www.instagram.com/tbilisimedic.ge"
                target="_blank"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 hover:bg-white/8 transition-colors"
              ...
              <a
                href="https://www.linkedin.com/company/tbilisi-medic/"
                target="_blank"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 hover:bg-white/8 transition-colors"
                aria-label="LinkedIn"
              >
              ...
              <a
                href="https://www.youtube.com/@tbilisimedic-ge"
                target="_blank"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 hover:bg-white/8 transition-colors"
                aria-label="YouTube"
              >
