...
import { AdminHeader, BlogTable, BlogFormModal } from '@/components/admin';
...
const posts = [
  {
    id: '1',
    title: 'სამედიცინო ტექნოლოგიების განვითარება',
    category: 'news',
    content:
  ...
  {
    id: '2',
    title: 'ახალი პროდუქტების პრეზენტაცია',
    category: 'events',
    content:
  ...
  {
    id: '3',
    title: 'ჯანდაცვის სისტემის მოდერნიზაცია',
    category: 'blog',
    content:
      '<p>დუის აუთე ირურე დოლორ ინ რეპრეჰენდერით ინ ვოლუპთათე ველით ესსე ცილუმ დოლორე ეუ ფუგიათ ნულა პარიათურ.</p><ul><li>პუნქტი პირველი</li><li>პუნქტი მეორე</li></ul>',
    createdAt: '2025-01-20',
  },
  {
    id: '4',
    title: 'პოდკასტი: მედიცინის მომავალი',
    category: 'podcast',
    content:
  ...
  {
    id: '5',
    title: 'ყოველდღიური ჩანაწერები კლინიკიდან',
    category: 'diaries',
    content:
        ...
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="mt-4 flex items-center justify-between">
            <p className="whitespace-nowrap text-sm text-foreground/60">
              სულ: {filteredPosts.length} პოსტი
            </p>
